...
COMMON_JS = '''
    <script>
            ...
            input.addEventListener('change', function(e) {
                ...
                if (file) {
                    ...
                    reader.onload = function(ev) {
                        frame.innerHTML = '<img src="'+ev.target.result+'" alt="Preview" style="max-width:100%;max-height:150px;object-fit:cover;">';
                    };
        ...
        function capturePhoto(doc) {
            ...
            frame.innerHTML = '<img src="' + dataURL + '" alt="Captured ' + doc.toUpperCase() + '" style="max-width:100%;max-height:150px;object-fit:cover;">';
